  ...
  useEffect(() => {
    if (googleLoaded) {
      const map = new window.google.maps.Map(
        ...
        {
          center: { lat: -36.414751, lng: -72.511329 },
          zoom: 10,
        }
      );
    }
  ...
  useEffect(() => {
    ...
    function initMap(): void {
      map = new google.maps.Map(document.getElementById("map") as HTMLElement, {
        center: { lat: -36.418858, lng: -72.51649 },
        zoom: 12,
        mapTypeId: "satellite",
        zoomControl: true,
        mapTypeControl: true,
      ...
      let infoWindow = new window.google.maps.InfoWindow({
        ...
        position: { lat: -36.418858, lng: -72.51649 },
      });

      infoWindow.open(map);
      // Configure the click listener.
      map.addListener("click", (mapsMouseEvent: google.maps.MouseEvent) => {
